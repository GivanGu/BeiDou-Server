...
VALUES ('zh-CN', 'game_config', 'quest_complete_hp_bonus', '完成任务是否随机增加3~10点最大HP');
 
INSERT INTO `lang_resources` (`lang_type`, `lang_base`, `lang_code`, `lang_value`) 
VALUES ('en-US', 'game_config', 'quest_complete_hp_bonus', 'Whether to gain 3~10 random MaxHP on quest completion');